...
/**
 * Publisher for geohash-routed messages to ETX, NMI, and AV MQTT brokers. Consumes
 * GeoHashRoutedMsg protobuf messages from Kafka. ETX may publish a GeoHashRoutedMsg wire form when
 * {@code j2735_gr} is configured; NMI/AV always receive the inner ASN.1 bytes only.
 */
@Component
@Slf4j
...
public class GeohashMqttPublisher extends AbstractMqttDepositor {
   ...
   */
  public GeohashMqttPublisher(MecDepositProperties mecDepositProperties, EtxProperties etxProperties,
