...
/**
 * Enables a bean when the MQTT depositor kind (e.g. {@code bsm}, {@code psm}) is enabled on at least one MQTT
...
public @interface ConditionalOnAnyMqttBrokerMqttDepositor {
  ...
  /**
   * Depositor key matching YAML nodes under {@code depositors} (e.g. {@code bsm}, {@code psm}, {@code spat}).
   */
  String value();
}
