...
/**
 * API client for interacting with the Partner API. This class handles registration,
 * authentication, and data exchange with the partner system.
 */
@Slf4j
@Component
public class PartnerClient {
  ...
  /**
   * Constructs a new Partner API client.
   *
   * @param properties The ETX configuration properties
   */
  public PartnerClient(EtxProperties properties, PartnerApiProperties partnerApi,
  ...
  /**
   * Registers this client with the Partner API.
   *
  ...
  /**
   * Handles the registration of a new client partner with the partner system. This includes
   * certificate generation and connection establishment.
   *
  ...
  /**
   * Gets an authentication token from the Partner API.
   *
  ...
  /**
   * Registers a new client with the Partner API.
   *
  ...
  /**
   * Gets an existing registration from the Partner API.
   *
   * @param token Authentication token
   * @return The registration response
   */
  ...
  /**
   * Establishes a connection with the Partner API.
   *
   * @param token Authentication token
  ...
  /**
   * Deposits data to the Partner API.
   *
   * @param token Authentication token
