...
/**
 * Depositor for SPAT (Signal Phase and Timing) messages to ETX, NMI, and AV MQTT brokers.
 */
@Component
@Slf4j
...
public class SpatMqttDepositor extends AbstractMqttDepositor {
  ...
  /**
   * Constructs a new SpatMqttDepositor with the specified dependencies.
   *
   ...
   * @param mqttService Service for publishing messages to the ETX MQTT broker
   * @param registry Metrics registry for monitoring and instrumentation
   * @param kafkaTemplate Template for Kafka operations
   */
  @Autowired
  public SpatMqttDepositor(MecDepositProperties mecDepositProperties,
