...
/**
 * Depositor for handling MAP messages via ETX API integration.
 */
@Component
@Slf4j
@ConditionalOnProperty(
    value = {"mec-deposit.etx.mqtt-brokers.etx.depositors.map.api.enabled",
        "mec-deposit.etx.enabled"},
    havingValue = "true")
public class MapApiDepositor extends AbstractApiDepositor {

  /**
   * Constructs a new MapApiDepositor.
   *
   ...
   */
  public MapApiDepositor(MecDepositProperties mecDepositProperties, EtxProperties etxProperties,
   ...
   */
  @KafkaListener(topics = "${mec-deposit.etx.mqtt-brokers.etx.depositors.map.api.kafka-topic}",
