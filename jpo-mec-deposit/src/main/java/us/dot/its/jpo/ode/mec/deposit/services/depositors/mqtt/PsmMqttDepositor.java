...
/**
 * Depositor for PSM (Personal Safety Message) via multi-broker MQTT fanout.
 */
@Component
@Slf4j
@ConditionalOnAnyMqttBrokerMqttDepositor("psm")
public class PsmMqttDepositor extends AbstractMqttDepositor {
   ...
   */
  @Autowired
  public PsmMqttDepositor(MecDepositProperties mecDepositProperties, EtxProperties etxProperties,
   ...
   *
   * @param message PSM ODE frame JSON
   */
