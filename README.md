[![GitHub Release](https://img.shields.io/github/v/release/usdot-jpo-ode/jpo-mec-deposit)](https://github.com/usdot-jpo-ode/jpo-mec-deposit/releases) [![Docker Hub Build](https://github.com/usdot-jpo-ode/jpo-mec-deposit/actions/workflows/dockerhub.yml/badge.svg?branch=develop)](https://github.com/usdot-jpo-ode/jpo-mec-deposit/actions/workflows/dockerhub.yml?query=branch:develop) [![Tests](https://github.com/usdot-jpo-ode/jpo-mec-deposit/actions/workflows/ci.yml/badge.svg?branch=develop)](https://github.com/usdot-jpo-ode/jpo-mec-deposit/actions/workflows/ci.yml?query=branch:develop) [![Docker Pulls](https://img.shields.io/docker/pulls/usdotjpoode/jpo-mec-deposit?label=Docker%20Pulls%20%28jpo-mec-deposit%20releases%29)](https://hub.docker.com/r/usdotjpoode/jpo-mec-deposit) [![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=usdot-jpo-ode_jpo-mec-deposit\&metric=alert_status)](https://sonarcloud.io/project/overview?id=usdot-jpo-ode_jpo-mec-deposit) [![License](https://img.shields.io/github/license/usdot-jpo-ode/jpo-ode)](https://github.com/usdot-jpo-ode/jpo-ode)
